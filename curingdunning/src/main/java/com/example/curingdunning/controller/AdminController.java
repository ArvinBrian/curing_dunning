...
public class AdminController {
	...
	@GetMapping("/events")
	public ResponseEntity<List<AllEventsViewDTO>> getAllDunningEvents(
	        @RequestParam(required = false) String status,
	        @RequestParam(required = false) String planType,
	        @RequestParam(required = false) String serviceName) {
	    List<AllEventsViewDTO> events = adminService.getAllDunningEvents(status, planType, serviceName);
	...
	@PutMapping("/rules/{id}")
	public ResponseEntity<DunningRule> updateRule(@PathVariable Long id,
			@Valid @RequestBody AdminDunningRuleDTO ruleDTO) {
	...
	public ResponseEntity<String> updateSubscription(@PathVariable Long subscriptionId,
	...
	public ResponseEntity<String> updateServiceStatus(@PathVariable Long customerId, @PathVariable String serviceName,
	...
	// **NEW DEDICATED ENDPOINT: /api/admin/customers/all**
